...
import { linksServer } from "@/serviceApi/links-server"
...
export function Details({ tripId }: { tripId: string }) {
  ...
  async function handleCreateTripLink() {
    try {
      if (!linkTitle.trim()) {
        return Alert.alert("Link", "Inform a title for the link.")
      }
  ...
  return (
    <View className="flex-1 mt-10">
      ...
      <Modal
        title="Register link"
        subtitle="All guests can view all registered links."
